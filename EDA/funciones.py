...
def tipo_datos(df):
    '''
    Realiza un análisis de los tipos de datos y de valores nulos en un DataFrame.

    Esta función toma un DataFrame como entrada y devuelve un resumen sobre
    los tipos de datos en cada columna, el porcentaje de valores no nulos y nulos, 
    así como la cantidad de valores nulos por columna.
